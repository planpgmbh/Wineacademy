    ...
    <div className="drawer drawer-end">
      ...
      <div className="drawer-side">
        ...
        <aside className="flex h-full w-96 max-w-full flex-col bg-base-100 shadow-xl">
          <header className="flex items-center justify-between gap-4 px-6 py-4 shadow-sm shadow-base-200/70">
          ...
          <footer className="flex flex-col gap-4 px-6 py-6 shadow-[0_-6px_12px_-8px_rgb(15_23_42_/_0.12)]">
