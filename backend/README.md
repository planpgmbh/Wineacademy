...
- **ENV-Variablen:**
  ...
  - SevDesk: `SEVDESK_API_TOKEN` (Pflicht), optional `SEVDESK_API_BASE_URL` (Standard `https://my.sevdesk.de/api/v1`), `SEVDESK_CATEGORY_PRIVATE_ID`, `SEVDESK_CATEGORY_COMPANY_ID`, `SEVDESK_DEFAULT_TIME_TO_PAY_DAYS`, `SEVDESK_DEFAULT_COUNTRY_ID`, `SEVDESK_TAX_RULE_ID`.
...
- `SEVDESK_API_TOKEN` muss im Backend-ENV hinterlegt sein; optional `SEVDESK_API_BASE_URL` für Sandbox/Staging.
