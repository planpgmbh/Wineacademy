...
export interface ApiOrtOrt extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    land: Schema.Attribute.Enumeration<['Deutschland']> &
      Schema.Attribute.Required &
    ...
    typ: Schema.Attribute.Enumeration<['vorort', 'online']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'vorort'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSeminarSeminar extends Struct.CollectionTypeSchema {
  collectionName: 'seminare';
  info: {
    description: 'Grundinformationen eines Seminars/Kurses';
    displayName: 'Seminar';
    pluralName: 'seminare';
...
export interface ApiTerminTermin extends Struct.CollectionTypeSchema {
  collectionName: 'termine';
  info: {
    description: 'Seminar-Termin mit mehreren Tagen (Datum, Start- und Endzeit)';
    displayName: 'Termin';
    pluralName: 'termine';
    singularName: 'termin';
  };
